        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-teal-500 to-cyan-600 hover:from-teal-600 hover:to-cyan-700 text-white px-8 py-6 text-lg shadow-2xl hover:shadow-teal-500/50 transition-all hover:scale-105 group"
            >
              {heroData.cta}
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-white/10 backdrop-blur-md border-2 border-white/30 text-white hover:bg-white/20 px-8 py-6 text-lg transition-all hover:scale-105 group"
            >
