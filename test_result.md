...
```bash
curl -s https://smartflags-clone.preview.emergentagent.com/api/roles
```
- Status: SUCCESS
...
✅ **Test 2: Role Seeding**
```bash
curl -s -X POST https://smartflags-clone.preview.emergentagent.com/api/roles/seed
```
- Status: SUCCESS
...
```bash
curl -X POST https://smartflags-clone.preview.emergentagent.com/api/admin/create \
...
✅ **Test 4: OTP Request**
```bash
curl -X POST https://smartflags-clone.preview.emergentagent.com/api/user/request-otp \
